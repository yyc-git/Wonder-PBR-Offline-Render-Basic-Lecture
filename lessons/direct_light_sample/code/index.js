...
import { getConfig, setConfig, setScene, getPass, getWebGPU } from "./data/Repo.js";
import { createCamera } from "./scene/Camera.js";
import { exec as init } from "./pipeline/InitPipeline.js";
import { exec as update } from "./pipeline/UpdatePipeline.js";
...
let _loopAndGenerateImage = async (frameCount, isRender) => {
    ...
    await _generateImage(path.join(process.cwd(), "lessons/direct_light_sample/output"));
}
