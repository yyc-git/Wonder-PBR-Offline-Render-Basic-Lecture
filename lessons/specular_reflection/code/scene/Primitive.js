...
import { createBRDFSpecularReflectionMaterial } from "./BRDFSpecularReflectionMaterial.js";
...
let _createMaterial = (lambertianMaterialData, specularReflectionMaterialData) => {
    if (_hasMaterialData(lambertianMaterialData)) {
        return createBRDFLambertianMaterial(lambertianMaterialData);
    }

    return createBRDFSpecularReflectionMaterial(specularReflectionMaterialData);
}
